...
?>
 	...
 	<div class="col-sm-12 admin_header"><p>Print out Fee</p></div>

 	<form method="post" action="print_schoolfee.php" target="_blank" >
...
<div class=" form-group col-xs-12">
<div class="col-xs-12"><input type="submit" id="view" name="view" value="Print">
</div>
</div>
