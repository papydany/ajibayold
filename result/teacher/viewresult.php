...
<div class="col-sm-12" style="padding-top:15px;">
 ...
 <div class="col-sm-12 formBg">
       ...
       <form class="form-horizontal" method="get" action="processresult.php" target="_blank">
 <div class="form-group"> <label class="col-sm-2 control-label">Term</label>
     ...
     <div class="form-group">
         <div class="col-sm-6 col-sm-offset-4">
              <input type="submit" name="submit" class="btn btn-warning" id="continue"  value="Continue">
